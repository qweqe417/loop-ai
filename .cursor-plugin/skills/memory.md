...
```bash
python CURSOR_PLUGIN_ROOT_PLACEHOLDER/engines/run.sh memory stats --format json
```
...
```bash
python CURSOR_PLUGIN_ROOT_PLACEHOLDER/engines/run.sh memory update --format json
```
